...
const Data := preload('inventory_item_glyph_x_state.gd')

var state: Data = load("res://game/inventory_items/glyph_x/inventory_item_glyph_x.tres")
...
func on_look_at() -> void:
	await C.Tibs.say("Looks familiar.")
