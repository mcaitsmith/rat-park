...
const Data := preload('inventory_item_highlighter_cap_state.gd')

var state: Data = load("res://game/inventory_items/highlighter_cap/inventory_item_highlighter_cap.tres")
...
func on_look_at() -> void:
	await C.Tibs.say("Tibs grip easy. Make fun toy?")
