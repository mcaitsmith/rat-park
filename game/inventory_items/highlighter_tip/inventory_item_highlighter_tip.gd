...
const Data := preload('inventory_item_highlighter_tip_state.gd')

var state: Data = load("res://game/inventory_items/highlighter_tip/inventory_item_highlighter_tip.tres")
...
func on_look_at() -> void:
	await C.Tibs.say("Tibs got yellow.")
