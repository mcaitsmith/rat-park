...
const Data := preload('inventory_item_screw_state.gd')

var state: Data = load("res://game/inventory_items/screw/inventory_item_screw.tres")
...
func on_look_at() -> void:
	await C.Tibs.say("Tibs got big metal thingy.")
